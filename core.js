...
:
(() => {return (((__EQUALS__ )((count )(args ) ,1 ) ) ?
(() => {return (first )(args );
} )()
:
(() => {return (((__EQUALS__ )((count )(args ) ,2 ) ) ?
...
let string__QUESTION_MARK__  = ((a ) => {return (__EQUALS__ )(typeof a  ,`string` );
} ) ;
let number__QUESTION_MARK__  = ((a ) => {return (__EQUALS__ )(typeof a  ,`number` );
} ) ;
let keyword__QUESTION_MARK__  = ((a ) => {return (__EQUALS__ )(typeof a  ,`symbol` );
} ) ;
let boolean__QUESTION_MARK__  = ((a ) => {return (__EQUALS__ )(typeof a  ,`boolean` );
} ) ;
let nil__QUESTION_MARK__  = ((a ) => {return (__EQUALS__ )(a ,null );
} ) ;
...
let true__QUESTION_MARK__  = ((a ) => {return (__EQUALS__ )(a ,true );
} ) ;
let false__QUESTION_MARK__  = ((a ) => {return (__EQUALS__ )(a ,false );
} ) ;
...
let defined__QUESTION_MARK__  = ((a ) => {return (not )((__EQUALS__ )(a ,undefined ) );
} ) ;
let undefined__QUESTION_MARK__  = ((a ) => {return (__EQUALS__ )(undefined ,a );
} ) ;
...
let reduce  = ((...args ) => {return (((__EQUALS__ )((count )(args ) ,2 ) ) ?
...
(() => {return ((((f ) => {return (((args ) => {return (((__EQUALS__ )(type ,`first` ) ) ?
(() => {return (apply )(f ,acc ,args );
} )()
:
(() => {return (((__EQUALS__ )(type ,`last` ) ) ?
(() => {return (f )(...args ,acc );
} )()
:
...
:
(() => {return (((map__QUESTION_MARK__ )(coll ) ) ?
(() => {return (((every__QUESTION_MARK__ )(((v ) => {return (and )((array__QUESTION_MARK__ )(v ) ,(__EQUALS__ )((count )(v ) ,2 ) );
} ) ,vals ) ) ?
...
} ) )((__MINUS____GREATER_THAN____GREATER_THAN__ )(m ,arr ,[remove ,((tuple ) => {return (__EQUALS__ )((first )(tuple ) ,k );
...
((exp )[(`or` )] = (or ));
((exp )[(`and` )] = (and ));
((exp )[(`zero?` )] = (zero__QUESTION_MARK__ ));
((exp )[(`count` )] = (count ));
((exp )[(`empty?` )] = (empty__QUESTION_MARK__ ));
((exp )[(`first` )] = (first ));
((exp )[(`ffirst` )] = (ffirst ));
((exp )[(`second` )] = (second ));
((exp )[(`third` )] = (third ));
...
((exp )[(`next` )] = (next ));
((exp )[(`cons` )] = (cons ));
((exp )[(`string?` )] = (string__QUESTION_MARK__ ));
((exp )[(`number?` )] = (number__QUESTION_MARK__ ));
((exp )[(`keyword?` )] = (keyword__QUESTION_MARK__ ));
((exp )[(`boolean?` )] = (boolean__QUESTION_MARK__ ));
((exp )[(`nil?` )] = (nil__QUESTION_MARK__ ));
((exp )[(`set?` )] = (set__QUESTION_MARK__ ));
((exp )[(`map?` )] = (map__QUESTION_MARK__ ));
((exp )[(`array?` )] = (array__QUESTION_MARK__ ));
((exp )[(`arr` )] = (arr ));
((exp )[(`array` )] = (array ));
((exp )[(`set` )] = (set ));
((exp )[(`hash-set` )] = (hash__MINUS__set ));
((exp )[(`hash-map` )] = (hash__MINUS__map ));
((exp )[(`tuples->map` )] = (tuples__MINUS____GREATER_THAN__map ));
((exp )[(`keys` )] = (keys ));
((exp )[(`vals` )] = (vals ));
((exp )[(`pairwise` )] = (pairwise ));
((exp )[(`log` )] = (log ));
((exp )[(`+` )] = (__PLUS__ ));
((exp )[(`-` )] = (__MINUS__ ));
((exp )[(`*` )] = (__ASTERISK__ ));
((exp )[(`/` )] = (__FORWARD_SLASH__ ));
((exp )[(`%` )] = (__PERCENT__ ));
((exp )[(`<` )] = (__LESS_THAN__ ));
((exp )[(`<=` )] = (__LESS_THAN____EQUALS__ ));
((exp )[(`>` )] = (__GREATER_THAN__ ));
((exp )[(`>=` )] = (__GREATER_THAN____EQUALS__ ));
((exp )[(`inc` )] = (inc ));
((exp )[(`dec` )] = (dec ));
((exp )[(`true?` )] = (true__QUESTION_MARK__ ));
((exp )[(`false?` )] = (false__QUESTION_MARK__ ));
((exp )[(`truthy?` )] = (truthy__QUESTION_MARK__ ));
((exp )[(`falsey?` )] = (falsey__QUESTION_MARK__ ));
((exp )[(`defined?` )] = (defined__QUESTION_MARK__ ));
((exp )[(`undefined?` )] = (undefined__QUESTION_MARK__ ));
((exp )[(`not` )] = (not ));
((exp )[(`even?` )] = (even__QUESTION_MARK__ ));
((exp )[(`odd?` )] = (odd__QUESTION_MARK__ ));
((exp )[(`apply` )] = (apply ));
((exp )[(`map` )] = (map ));
((exp )[(`filter` )] = (filter ));
((exp )[(`remove` )] = (remove ));
...
((exp )[(`comp` )] = (comp ));
((exp )[(`partial` )] = (partial ));
((exp )[(`->` )] = (__MINUS____GREATER_THAN__ ));
((exp )[(`->>` )] = (__MINUS____GREATER_THAN____GREATER_THAN__ ));
((exp )[(`raise` )] = (raise ));
((exp )[(`get` )] = (get ));
((exp )[(`get-in` )] = (get__MINUS__in ));
((exp )[(`contains?` )] = (contains__QUESTION_MARK__ ));
((exp )[(`every?` )] = (every__QUESTION_MARK__ ));
((exp )[(`conj` )] = (conj ));
((exp )[(`disj` )] = (disj ));
((exp )[(`drop` )] = (drop ));
((exp )[(`take` )] = (take ));
((exp )[(`flatten-1` )] = (flatten__MINUS__1 ));
((exp )[(`assoc` )] = (assoc ));
((exp )[(`assoc-in` )] = (assoc__MINUS__in ));
((exp )[(`dissoc` )] = (dissoc ));
((exp )[(`update` )] = (update ));
((exp )[(`update-in` )] = (update__MINUS__in ));
((exp )[(`str` )] = (str ));
((exp )[(`max` )] = (max ));
((exp )[(`min` )] = (min ));
((exp )[(`int?` )] = (int__QUESTION_MARK__ ));
((exp )[(`float?` )] = (float__QUESTION_MARK__ ));
((exp )[(`neg?` )] = (neg__QUESTION_MARK__ ));
((exp )[(`pos?` )] = (pos__QUESTION_MARK__ ));
((exp )[(`rand` )] = (rand ));
((exp )[(`rand-int` )] = (rand__MINUS__int ));
((exp )[(`repeat` )] = (repeat ));
((exp )[(`repeatedly` )] = (repeatedly ));
((exp )[(`complement` )] = (complement ));
((module )[(`exports` )] = (exp ));
